                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/pemesanan/{{$item->id}}" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="nomor_polisi">Kendaraan</label>
                                                <select name="kendaraan_id" class="form-control" required disabled>
                                                    @foreach ($kendaraans as $kendaraan)
                                            ...
                                            <div class="form-group">
                                                <label for="merk">Merk</label>
                                                <label for="driver_id">Pilih Driver</label>
                                                <select name="driver_id" class="form-control" required disabled>
                                                    @foreach ($drivers as $driver)
                                            ...
                                            <div class="form-group">
                                                <label for="approved_by">Pihak yang Menyetujui</label>
                                                <select name="approved_by" class="form-control" disabled>
                                                    <option value="" disabled>-- Pilih Admin --</option>
                                                    @foreach ($approvers as $approver)
                                            ...
                                            <div class="form-group">
                                                <label for="tanggal_pemesanan">Tanggal Pemesanan</label>
                                                <input disabled type="date" name="tanggal_pemesanan" class="form-control" required value="{{$item->tanggal_pemesanan}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="status">Status</label>
                                                <select name="status" class="form-control" required>
